<template>
    <ion-content>
        <div class="allContent" :class="{ 'showMain': documentVisible, 'epic-hide': isHide }">
            ...
            <div class="selectInv">
                <div class="newInv" @click="redirect1">
                    <p>Agregar Nuevo</p>
                    <img src="@/media/icon5.svg" alt="New">
                </div>
                <div class="newInv2" @click="redirect2">
                    <p>Ver Todos</p>
                    <img src="@/media/icon6.svg" alt="Vall">
                </div>
            </div>
        </div>
    </ion-content>
...
export default {
    ...
    methods: {
        ...
        redirect1() {
            this.isHide = true;
            setTimeout(() => {
                window.location.href = "/invBase"
            }, 500);
        },
        redirect2() {
            this.isHide = true;
            setTimeout(() => {
                window.location.href = "/invVA"
            }, 500);
        },
    }
}
...
.selectInv {
    ...
    align-items: center;
    /* background-color: red; only test */
}
